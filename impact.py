...
impact_values = [closeness * betweenness for closeness, betweenness in zip(closeness_dict.values(), betweenness_dict.values())]
node_trace.marker.color = impact_values
